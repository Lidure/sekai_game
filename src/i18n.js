...
const Lang = {
    ...
    EN: {
        ...
        selectDevicePC: 'PC (Keyboard)',
        selectDeviceMobile: 'MOBILE (Touch)',
        selectDeviceHint: '(↑/↓) J to confirm',
        selectDeviceHintMobile: 'Tap your choice',
        on: 'ON',
        off: 'OFF',
    ...
    CN: {
        ...
        mobile: '移动端',
        selectDevice: '选择设备',
        selectDevicePC: 'PC（键盘）',
        selectDeviceMobile: '移动端（触屏）',
        selectDeviceHint: '(↑/↓) J 确认',
        selectDeviceHintMobile: '点击选择',
        on: '\u5F00',
        off: '\u5173',
